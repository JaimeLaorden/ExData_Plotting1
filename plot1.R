...
#
# Building Plot1, copying it into a graphic device png file, closing the graphic device png
hist(temp_GAP, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", font.lab=6, font.axis=6)
dev.copy(png, file="plot1.png")
dev.off()

# Dropping temporary variables and data structures
rm(temp_GAP)
rm(filter)
